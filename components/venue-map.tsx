...
interface VenueMapProps {
  locationType: 'church' | 'reception';
}

export default function VenueMap({ locationType }: VenueMapProps) {
  ...
  const config = {
    church: {
      mapUrl: "/map-venue.png",
      googleMapsUrl: "https://maps.app.goo.gl/z73bg2mCF4u21LKu8",
      nameEn: "Great St. Antony Church",
      nameAr: "كنيسة الأنبا أنطونيوس العظيم",
      subEn: "Zahraa El Maadi",
      subAr: "زهراء المعادي"
    },
    reception: {
      mapUrl: "/map-venue2.png",
      googleMapsUrl: "https://maps.app.goo.gl/yEYNKkeibvq9TGt19",
      nameEn: "The Grove",
      nameAr: "ذا جروف",
      subEn: "Elshorouk",
      subAr: "الشروق"
  ...
  const { mapUrl, googleMapsUrl, nameEn, nameAr, subEn, subAr } = config[locationType] || config.church;
      ...
      <div className="max-w-4xl mx-auto">
        <div className="relative group">
          ...
          <div className="mt-4 text-center px-4">
            <h3 className="text-xl sm:text-2xl font-serif font-medium text-foreground mb-1">
              {isRTL ? nameAr : nameEn}
            </h3>
            <div className="text-muted-foreground text-sm sm:text-base mb-2 space-y-1">
              {isRTL ? (
                <><div>{subAr}</div></>
              ) : (
                <><div>{subEn}</div></>
